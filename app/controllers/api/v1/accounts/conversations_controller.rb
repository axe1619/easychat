class Api::V1::Accounts::ConversationsController < Api::V1::Accounts::BaseController
  ...
  def permitted_update_params
    ...
    params.permit(:priority,:kanban_states_id,:score,:justification,:conversation_sentiment_id,:last_sentiment_analysis,:active_agent_bot,:enabled_remarketing,:conversations_state_id)
  end
